package com.rookiefly.springboot.sam.exception;
 ...
 * <p>
 * JwtRealm#doGetAuthenticationInfo() 抛出 CustomAuthenticationException
 * CustomAuthenticationException比父类多了一个code属性，前端通过code来判断token是否失效
 * <p>
 * 最后通过全局异常处理器MyControllerAdvice#errorHandler()返回自定义信息给前端
 */
@Data
