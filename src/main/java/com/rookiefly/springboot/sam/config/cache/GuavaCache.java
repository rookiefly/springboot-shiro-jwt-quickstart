...
public class GuavaCache extends AbstractValueAdaptingCache {
    ...
    @Override
    public final com.google.common.cache.Cache getNativeCache() {
        return this.cache;
    }
    ...
    @Override
    public Object get(Object key, final Callable valueLoader) {
        try {
            return fromStoreValue(this.cache.get(key, new Callable() {
                @Override
